package com.davidsgk.bullet360.camera;
...
public class OrthoCamera extends OrthographicCamera {
    ...
    public OrthoCamera() {
        this(new VirtualViewport(Bullet360.WIDTH, Bullet360.HEIGHT));
    }
    ...
    public void resize() {
        VirtualViewport virtualViewport = new VirtualViewport(Bullet360.WIDTH, Bullet360.HEIGHT);
