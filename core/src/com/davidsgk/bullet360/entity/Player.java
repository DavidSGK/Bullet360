...
public class Player extends Entity {
    ...
    public void update() {
        ...
        if(this.getBounds().getX() < 0 || this.getBounds().getX() > Bullet360.WIDTH){
            this.pos.x += Math.abs(this.getBounds().getX());
        } else if(this.getBounds().getX() + this.getBounds().getWidth() > Bullet360.WIDTH){
            this.pos.x -= Math.abs(this.getBounds().getX() + this.getBounds().getWidth() - Bullet360.WIDTH);
        }
